...
namespace EnglishTrainer.Client.СonstructorTimes
{
	...
	public partial class Present : Form
	{
		...
		*/
		...
		{
			textBox3.Text =	"Синтаксис: [Местоимение] + [глагол V1/V + окончание s, es, ies] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, You, We, They ] + [ V1 / V ]" + Environment.NewLine +
		...
		{
			textBox4.Text = "Синтаксис: [Местоимение] + [does/do] + [not] + [V1/V] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, You, We, They ] + [ do ] + [ not ] + [ V1 / V ]" + Environment.NewLine +
							"[ He, She, It ] + [ does ] + [ not ] + [ V1 / V ]";
		}
		...
		{
			textBox6.Text = "Синтаксис: [Does/Do] + [Местоимение] + [V1/V] + [Что; Где; Когда] ?" + Environment.NewLine +
							"[ Do ] + [ I, You, We, They ] + [ V1 / V ] ?" + Environment.NewLine +
							"[ Does ] + [ He, She, It ] + [ V1 / V ] ?";
		}
		...
		void ToolStripButton30Click(object sender, EventArgs e)
		{
			...
			textBox12.Text =	"Синтаксис: [Местоимение] + [am/is/are] + [глагол V4/V + окончание ing] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I ] + [ am ] + [ V4 / V + ing]" + Environment.NewLine +
							"[ He, She, It ] + [ is ] + [ V4 / V + ing]" + Environment.NewLine +
							"[ We, You, They ] + [ are ] + [ V4 / V + ing]";
		}
		void ToolStripButton25Click(object sender, EventArgs e)
		{

			textBox10.Text =	"Синтаксис: [Местоимение] + [am/is/are] + [not] + [V4/V + окончание ing] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I ] + [ am ] + [ not ] + [ V4 / V + ing ]" + Environment.NewLine +
							"[ He, She, It ] + [ is ] + [ not ] + [ V4 / V + ing ]" + Environment.NewLine +
							"[ We, You, They ] + [ are ] + [ not ] + [ V4 / V + ing ]";
		}
		void ToolStripButton20Click(object sender, EventArgs e)
		{
			textBox8.Text =	"Синтаксис: [Am/Is/Are] + [Местоимение] + [V4/V + окончание ing] + [Что; Где; Когда] ?" + Environment.NewLine +
							"[ Am ] + [ I ] + [ V4 / V + ing ] ?" + Environment.NewLine +
							"[ Is ] + [ He, She, It ] + [ V4 / V + ing ] ?" + Environment.NewLine +
							"[ Are ] + [ We, You, They ] + [ V4 / V + ing ] ?";
		}
		...
		{
			textBox18.Text =	"Синтаксис: [Местоимение] + [have/has] + [глагол V3/V + окончание ed] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We, You, They ] + [ have ] + [ V3 / V + ed ]" + Environment.NewLine +
							"[ He, She, It ] + [ has ] + [ V3 / V + ed ]";
		}
		void ToolStripButton40Click(object sender, EventArgs e)
		{
			textBox16.Text =	"Синтаксис: [Местоимение] + [have/has] + [not] + [V3/V + окончание ed] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We, You, They ] + [ have ] + [ not ]+ [ V3 / V + ed ]" + Environment.NewLine +
							"[ He, She, It ] + [ has ] + [ not ] + [ V3 / V + ed ]";
		}
		void ToolStripButton35Click(object sender, EventArgs e)
		{
			textBox14.Text =	"Синтаксис: [Have/Has] + [Местоимение] + [V3/V + окончание ed] + [Что; Где; Когда] ?" + Environment.NewLine +
							"[ Have ] + [ I, We, You, They ] + [ V3 / V + ed ] ?" + Environment.NewLine +
		...
		{
			textBox24.Text = "Синтаксис: [Местоимение] + [have/has] + [been] + [глагол V4/V + окончание ing] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We, You, They ] + [ have ] + [ been ]  + [ V4 / V + ing ]" + Environment.NewLine +
							"[ He, She, It ] + [ has ] + [ been ] + [ V4 / V + ing ]";
		}
		void ToolStripButton55Click(object sender, EventArgs e)
		{
			textBox22.Text = "Синтаксис: [Местоимение] + [have/has] + [not] + [ been ] + [V4/V + окончание ing] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We, You, They ] + [ have ] + [ not ]+ [ been ] + [ V4 / V + ing ]" + Environment.NewLine +
							"[ He, She, It ] + [ has ] + [ not ] + [ been ] + [ V4 / V + ing ]";
		}
		void ToolStripButton50Click(object sender, EventArgs e)
		{
			textBox20.Text = "Синтаксис: [Have/Has] + [Местоимение] + [ been ] + [V4/V + окончание ing] + [Что; Где; Когда] ?" + Environment.NewLine +
							"[ Have ] + [ I, We, You, They ] + [ been ] + [ V4 / V + ing ] ?" + Environment.NewLine +
							"[ Has ] + [ He, She, It ] + [ been ] + [ V4 / V + ing ] ?";
		}
