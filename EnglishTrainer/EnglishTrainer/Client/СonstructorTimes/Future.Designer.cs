...
namespace EnglishTrainer.Client.СonstructorTimes
{
	partial class Future
	{
		...
		private void InitializeComponent()
		{
			...
			this.label5.Text = "Future Simple ссылается на действие, которое совершится в неопределенном или отда" +
	"ленном будущем.";
			...
			this.textBox6.Text = "Синтаксис: [Shall/Will] + [Местоимение] + [V1/V] + [Что; Где; Когда] ?\r\n[ Shall ]" +
	" + [ I, We ] + [ V1 / V ] ?\r\n[ Does ] + [ He, She, It, You, They ] + [ V1 / V ] " +
	"?";
			// 
			// textBox7
			// 
			...
			this.textBox4.Text = "Синтаксис: [Местоимение] + [shall/will] + [not] + [V1/V] + [Что; Где; Когда]\r\n[ I" +
	", We ] + [ shall/will ] + [ not ] + [ V1 / V ]\r\n[ He, She, It, You, They ] + [ w" +
	"ill ] + [ not ] + [ V1 / V ]";
			// 
			// textBox5
			// 
			...
			this.textBox3.Text = "Синтаксис: [Местоимение] + [shall/will] + [глагол V1/V] + [Что; Где; Когда]\r\n[ I," +
	...
	"1 / V ]";
			...
			this.label1.Text = "FUTURE SIMPLE (Простое будущее время)";
			...
			this.label8.Text = "Future Continuous - широко используется в английском языке. Как и все времена гру" +
	"ппы Continuous, оно передает продолжительное действие, происходящее в определенн" +
	"ый, указанный в контексте, момент. ";
			...
			this.label2.Text = "FUTURE CONTINUOUS (Длительное будущее время)";
			...
			this.label10.Text = "Future Perfect — будущее совершенное время обозначает действия, которое уже совер" +
	"шится и будет закончено к определенному моменту в будущем.";
			...
			this.label3.Text = "FUTURE PERFECT (Совершенное будущее время)";
			...
			this.label12.Text = "Future Perfect Continuous указывает на действие, которое началось и продолжалось " +
	"в течение некоторого времени до определенного момента в будущем.";
			...
			this.textBox22.Text = resources.GetString("textBox22.Text");
			// 
			// textBox23
			// 
			...
			this.label4.Text = "FUTURE PERFECT CONTINUOUS (Будущее длительное совершенное время)";
			...
			this.Name = "Future";
			this.Text = "Время: Future (Будущее)";
