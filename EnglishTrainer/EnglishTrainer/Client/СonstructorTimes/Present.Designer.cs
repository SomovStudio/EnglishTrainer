...
namespace EnglishTrainer.Client.СonstructorTimes
{
	partial class Present
	{
		...
		private void InitializeComponent()
		{
			...
			this.label5.Text = "Present Simple – простое настоящее время. Оно показывает действие, которое происх" +
	"одит регулярно, с определенной периодичностью.";
			...
			this.textBox6.Text = "Синтаксис: [Does/Do] + [Местоимение] + [V1/V] + [Что; Где; Когда] ?\r\n[ Do ] + [ I" +
	", You, We, They ] + [ V1 / V ] ?\r\n[ Does ] + [ He, She, It ] + [ V1 / V ] ?";
			// 
			// textBox7
			// 
			...
			this.textBox4.Text = "Синтаксис: [Местоимение] + [does/do] + [not] + [V1/V] + [Что; Где; Когда]\r\n[ I, Y" +
	"ou, We, They ] + [ do ] + [ not ] + [ V1 / V ]\r\n[ He, She, It ] + [ does ] + [ n" +
	"ot ] + [ V1 / V ]";
			// 
			// textBox5
			// 
			...
			this.textBox3.Text = "Синтаксис: [Местоимение] + [глагол V1/V + окончание s, es, ies] + [Что; Где; Когд" +
	"а]\r\n[ I, You, We, They ] + [ V1 / V ]\r\n[ He, She, It ] + [ V1 / V + s, es, ies ]" +
	"";
			// 
			// textBox2
			// 
			...
			this.label1.Text = "PRESENT SIMPLE (Простое настоящее время)";
			...
			this.label2.Text = "PRESENT CONTINUOUS (Настоящее длительное время)";
			...
			this.label10.Text = "Present Perfect (Present Perfect Simple) – настоящее совершенное время. Ему нет с" +
	"оответствий в русском языке. Действие в настоящем которое закончилось.";
			...
			this.textBox14.Text = "Синтаксис: [Have/Has] + [Местоимение] + [V3/V + окончание ed] + [Что; Где; Когда]" +
	" ?\r\n[ Have ] + [ I, We, You, They ] + [ V3 / V + ed ] ?\r\n[ Has ] + [ He, She, It" +
	" ] + [ V3 / V + ed ] ?";
			// 
			// textBox15
			// 
			...
			this.textBox18.Text = "Синтаксис: [Местоимение] + [have/has] + [глагол V3/V + окончание ed] + [Что; Где;" +
	" Когда]\r\n[ I, We, You, They ] + [ have ] + [ V3 / V + ed ]\r\n[ He, She, It ] + [ " +
	"has ] + [ V3 / V + ed ]";
			// 
			// textBox19
			// 
			...
			this.label3.Text = "PRESENT PERFECT (Настоящее совершенное время)";
			...
			this.label4.Text = "PRESENT PERFECT CONTINUOUS (Настоящее длительное совершенное время)";
			...
			this.Name = "Present";
			this.Text = "Время: Present (Настоящее)";
