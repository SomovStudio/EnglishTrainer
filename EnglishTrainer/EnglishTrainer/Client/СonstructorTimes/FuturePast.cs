...
namespace EnglishTrainer.Client.СonstructorTimes
{
	...
	/// </summary>
	public partial class FuturePast : Form
	{
		public FuturePast()
		{
			//
		...
		*/
		...
		{
			textBox3.Text =	"Синтаксис: [Местоимение] + [should/would] + [глагол V1/V] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We ] + [ should/would ] + [ V1 / V ]" + Environment.NewLine +
							"[ He, She, It, You, They ] + [ would ] + [ V1 / V ]";
		}
		...
		{
			textBox4.Text = "Синтаксис: [Местоимение] + [should/would] + [not] + [V1/V] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We ] + [ should/would ] + [ not ] + [ V1 / V ]" + Environment.NewLine +
							"[ He, She, It, You, They ] + [ would ] + [ not ] + [ V1 / V ]";
		}
		...
		{
			textBox6.Text = "Синтаксис: [Should/Would] + [Местоимение] + [V1/V] + [Что; Где; Когда] ?" + Environment.NewLine +
							"[ Should/Would ] + [ I, We ] + [ V1 / V ] ?" + Environment.NewLine +
							"[ Would ] + [ He, She, It, You, They ] + [ V1 / V ] ?";
		}
		void ПравильныеГлаголыToolStripMenuItemClick(object sender, EventArgs e)
		{
			GetWord(Constants.DATA_TYPE_REGULAR_VERBS, textBox2, Constants.VERB_INFINITIVE);
		}
		void НеправильныеГлаголыToolStripMenuItemClick(object sender, EventArgs e)
		{
			GetWord(Constants.DATA_TYPE_IRREGULAR_WORDS, textBox2, Constants.VERB_INFINITIVE);
		}
		...
		void ToolStripButton30Click(object sender, EventArgs e)
		{
			...
			textBox12.Text =	"Синтаксис: [Местоимение] + [should/would] + [be] + [глагол V4/V + окончание ing] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We ] + [ should/would ] + [ be ] + [ V4 / V + ing ]" + Environment.NewLine +
							"[ He, She, It, You, They ] + [ would ] + [ be ] + [ V4 / V + ing ]";
		}
		void ToolStripButton25Click(object sender, EventArgs e)
		{

			textBox10.Text =	"Синтаксис: [Местоимение] + [should/would] + [not] + [be] + [V4/V + окончание ing] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We ] + [ should/would ] + [ not ] + [ be ] + [ V4 / V + ing ]" + Environment.NewLine +
							"[ He, She, It, You, They] + [ would ] + [ not ] + [ be ] + [ V4 / V + ing ]";
		}
		void ToolStripButton20Click(object sender, EventArgs e)
		{
			textBox8.Text =	"Синтаксис: [Should/Would] + [Местоимение] + [be] + [V4/V + окончание ing] + [Что; Где; Когда] ?" + Environment.NewLine +
							"[ Should/Would ] + [ I, We ] + [ be ] + [ V4 / V + ing ] ?" + Environment.NewLine +
							"[ Would ] + [ He, She, It, You, They ] + [ be ] + [ V4 / V + ing ] ?";
		}
		...
		{
			textBox18.Text =	"Синтаксис: [Местоимение] + [should/would] + [have] + [глагол V3/V + окончание ed] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We ] + [ should/would ] + [ have ] + [ V3 / V + ed ]" + Environment.NewLine +
							"[ He, She, It, You, They ] + [ would ] + [ have ] + [ V3 / V + ed ]";
		}
		void ToolStripButton40Click(object sender, EventArgs e)
		{
			textBox16.Text =	"Синтаксис: [Местоимение] + [should/would] + [not] + [have] + [V3/V + окончание ed] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We ] + [ should/would ] + [ not ] + [ have ] + [ V3 / V + ed ]" + Environment.NewLine +
							"[ He, She, It, You, They ] + [ would ] + [ not ] + [ have ] + [ V3 / V + ed ]";
		}
		void ToolStripButton35Click(object sender, EventArgs e)
		{
			textBox14.Text =	"Синтаксис: [Should/Would] + [Местоимение] + [have] + [V3/V + окончание ed] + [Что; Где; Когда] ?" + Environment.NewLine +
							"[ Should/Would ] + [ I, We ] + [ have ] + [ V3 / V + ed ] ?" + Environment.NewLine +
							"[ Would ] + [ He, She, It, You, They ] + [ have ] + [ V3 / V + ed ] ?";
		}
		...
		{
			textBox24.Text = "Синтаксис: [Местоимение] + [should/would] + [have] + [been] + [глагол V4/V + окончание ing] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We ] + [ should/would ] + [ have ] + [ been ]  + [ V4 / V + ing ]" + Environment.NewLine +
							"[ He, She, It, You, They ] + [ would ] + [ have ] + [ been ] + [ V4 / V + ing ]";
		}
		void ToolStripButton55Click(object sender, EventArgs e)
		{
			textBox22.Text = "Синтаксис: [Местоимение] + [should/would] + [not] + [have] + [ been ] + [V4/V + окончание ing] + [Что; Где; Когда]" + Environment.NewLine +
							"[ I, We ] + [ should/would ] + [ not ] + [ have ] + [ been ] + [ V4 / V + ing ]" + Environment.NewLine +
							"[ He, She, It, You, They ] + [ would ] + [ not ] + [ have ] + [ been ] + [ V4 / V + ing ]";
		}
		void ToolStripButton50Click(object sender, EventArgs e)
		{
			textBox20.Text = "Синтаксис: [Should/Would] + [Местоимение] + [have] + [been] + [V4/V + окончание ing] + [Что; Где; Когда] ?" + Environment.NewLine +
							"[ Should/Would ] + [ I, We ] + [ have ] + [ been ] + [ V4 / V + ing ] ?" + Environment.NewLine +
							"[ Would ] + [ He, She, It, You, They ] + [ have] + [ been ] + [ V4 / V + ing ] ?";
		}
