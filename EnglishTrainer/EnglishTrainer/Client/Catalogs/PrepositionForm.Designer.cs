...
namespace EnglishTrainer.Client.Catalogs
{
	partial class PrepositionForm
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PrepositionForm));
			...
			// columnHeader2
			// 
			this.columnHeader2.Text = "Предлог";
			...
			this.Name = "PrepositionForm";
			this.Text = "Предлоги";
			this.Load += new System.EventHandler(this.PrepositionFormLoad);
