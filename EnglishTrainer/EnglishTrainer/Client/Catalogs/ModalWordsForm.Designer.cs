...
namespace EnglishTrainer.Client.Catalogs
{
	partial class ModalWordsForm
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ModalWordsForm));
			...
			// columnHeader2
			// 
			this.columnHeader2.Text = "Модальное слово";
			...
			this.Name = "ModalWordsForm";
			this.Text = "Модальные слова";
			this.Load += new System.EventHandler(this.ModalWordsFormLoad);
