...
{
	/// <summary>
	/// Description of NumeralForm.
	/// </summary>
	public partial class NumeralForm : Form
	{
		public NumeralForm()
		{
			//
		...
		void NumeralFormLoad(object sender, EventArgs e)
		{
			TableRefresh();
		}
		...
		void addFile()
		{
			...
			eForm.DataType = Constants.DATA_TYPE_NUMERAL;
