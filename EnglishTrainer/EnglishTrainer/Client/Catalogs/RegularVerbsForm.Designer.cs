...
{
	partial class RegularVerbsForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RegularVerbsForm));
			...
			// columnHeader2
			// 
			this.columnHeader2.Text = "Infinitive";
			this.columnHeader2.Width = 100;
			// 
			// columnHeader3
			// 
			this.columnHeader3.Text = "Past Simple";
			this.columnHeader3.Width = 100;
			// 
			// columnHeader4
			// 
			this.columnHeader4.Text = "Past participle";
			this.columnHeader4.Width = 100;
			// 
			// columnHeader5
			// 
			this.columnHeader5.Text = "Present Participle";
			...
			this.Name = "RegularVerbsForm";
			this.Text = "Правильные глаголы";
			this.Load += new System.EventHandler(this.RegularVerbsFormLoad);
