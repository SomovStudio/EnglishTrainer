...
namespace EnglishTrainer.Client.Catalogs
{
	partial class IntroWordsForm
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IntroWordsForm));
			...
			// columnHeader2
			// 
			this.columnHeader2.Text = "Вводное слово";
			...
			this.Name = "IntroWordsForm";
			this.Text = "Вводные слова";
			this.Load += new System.EventHandler(this.IntroWordsFormLoad);
