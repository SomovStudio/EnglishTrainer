...
namespace EnglishTrainer.Client.Catalogs
{
	partial class NumeralForm
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(NumeralForm));
			...
			// columnHeader2
			// 
			this.columnHeader2.Text = "Числительное";
			...
			this.Name = "NumeralForm";
			this.Text = "Числительные";
			this.Load += new System.EventHandler(this.NumeralFormLoad);
