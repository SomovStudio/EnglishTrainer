...
namespace EnglishTrainer.Client.Catalogs
{
	partial class IrregularVerbsForm
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IrregularVerbsForm));
			...
			this.listView1.Size = new System.Drawing.Size(851, 441);
			...
			// columnHeader2
			// 
			this.columnHeader2.Text = "Infinitive (V1)";
			this.columnHeader2.Width = 150;
			// 
			// columnHeader3
			// 
			this.columnHeader3.Text = "Past Simple (V2)";
			this.columnHeader3.Width = 150;
			// 
			// columnHeader4
			// 
			this.columnHeader4.Text = "Past Participle (V3)";
			this.columnHeader4.Width = 150;
			// 
			// columnHeader5
			// 
			this.columnHeader5.Text = "Present Participle (V4)";
			this.columnHeader5.Width = 150;
			// 
			// columnHeader6
			// 
			this.columnHeader6.Text = "Перевод";
			...
			this.buttonReturn.Location = new System.Drawing.Point(683, 10);
			...
			this.buttonClose.Location = new System.Drawing.Point(764, 10);
			...
			this.Name = "IrregularVerbsForm";
			this.Text = "Неправильные глаголы";
			this.Load += new System.EventHandler(this.IrregularVerbsFormLoad);
