...
namespace EnglishTrainer.Client.Catalogs
{
	partial class PronounsForm
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PronounsForm));
			...
			// columnHeader2
			// 
			this.columnHeader2.Text = "Местоимение";
			...
			this.Name = "PronounsForm";
			this.Text = "Местоимения";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.PronounsFormFormClosed);
			this.Load += new System.EventHandler(this.PronounsFormLoad);
